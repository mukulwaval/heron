...
#include "utilities/imgui_layout.h"
    ...
    public Application
{
    ...
    void OnStart() override
    {
        ...
        const char* path1 = "data/BlueprintBackground.png";
        const char* path2 = "data/ic_save_white_24dp.png";
        const char* path3 = "data/ic_restore_white_24dp.png";
        m_HeaderBackground = LoadTexture(path1);
        m_SaveIcon = LoadTexture(path2);
        m_RestoreIcon = LoadTexture(path3);
    ...
    void ShowStyleEditor(bool* show = nullptr)
    {
        ...
        ImLayout::BeginHorizontal("Style buttons", ImVec2(paneWidth, 0), 1.0f);
        ImGui::TextUnformatted("Values");
        ImLayout::Spring();
        if (ImGui::Button("Reset to defaults"))
            editorStyle = ed::Style();
        ImLayout::EndHorizontal();
        ImGui::Spacing();
        ...
        ImLayout::BeginHorizontal("Color Mode", ImVec2(paneWidth, 0), 1.0f);
    ...
    void ShowLeftPane(float paneWidth)
    {
        ...
        ImLayout::BeginHorizontal("Style Editor", ImVec2(paneWidth, 0));
        ImLayout::Spring(0.0f, 0.0f);
        if (ImGui::Button("Zoom to Content"))
            ed::NavigateToContent();
        ImLayout::Spring(0.0f);
...
# endif
        ...
        ImLayout::BeginHorizontal("Selection Stats", ImVec2(paneWidth, 0));
        ...
        ed::Begin("Node editor");
        {
            ...
            for (auto& node : m_Nodes)
            {
                ...
                if (!isSimple)
                {
                    ...
                    {
                        ImLayout::BeginVertical("delegates", ImVec2(0, 28));
                        ImLayout::Spring(1, 0);
                        for (auto& output : node.Outputs)
                        {
                            if (output.Type != PinType::Delegate)
                            ...
                            ImLayout::BeginHorizontal(output.ID.AsPointer());
                            ...
                            ImLayout::Spring(0, ImGui::GetStyle().ItemSpacing.x / 2);
                            ImLayout::EndHorizontal();
                            ImGui::PopStyleVar();
                            ed::EndPin();
            ...
            for (auto& node : m_Nodes)
            {
                ...
                ImLayout::BeginVertical(node.ID.AsPointer());
                ImLayout::BeginHorizontal("inputs");
                ImLayout::Spring(0, padding * 2);
                ...
                ImLayout::BeginHorizontal("content_frame");
                ImLayout::Spring(1, padding);

                ImLayout::BeginVertical("content", ImVec2(0.0f, 0.0f));
                ...
                ImLayout::BeginHorizontal("outputs");
                ImLayout::Spring(0, padding * 2);
            ...
            for (auto& node : m_Nodes)
            {
                ...
                ed::BeginNode(node.ID);
                ImGui::PushID(node.ID.AsPointer());
                ImLayout::BeginVertical("content");
                ImLayout::BeginHorizontal("horizontal");
                ImLayout::Spring(1);
                ImGui::TextUnformatted(node.Name.c_str());
                ImLayout::Spring(1);
                ImLayout::EndHorizontal();
...
# endif
    ...
    ImTextureID          m_HeaderBackground = (ImTextureID)nullptr;
    ImTextureID          m_SaveIcon = (ImTextureID)nullptr;
    ImTextureID          m_RestoreIcon = (ImTextureID)nullptr;
