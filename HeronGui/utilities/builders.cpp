...
void util::BlueprintNodeBuilder::Input(ed::PinId id)
{
    ...
    ImLayout::BeginHorizontal(id.AsPointer());
}
...
bool util::BlueprintNodeBuilder::SetStage(Stage stage)
{
    ...
    case Stage::Header:
        ...
        ImLayout::Spring(0, ImGui::GetStyle().ItemSpacing.y * 2.0f);
    ...
    {
    case Stage::Begin:
        ImLayout::BeginVertical("node");
        break;

    case Stage::Header:
        HasHeader = true;

        ImLayout::BeginHorizontal("header");
        break;
    ...
    case Stage::Content:
        ...
        ImLayout::BeginHorizontal("content");
        ImLayout::Spring(0, 0);
        break;

    case Stage::Input:
        ImLayout::BeginVertical("inputs", ImVec2(0, 0), 0.0f);
    ...
    case Stage::Middle:
        ImLayout::Spring(1);
        ImLayout::BeginVertical("middle", ImVec2(0, 0), 1.0f);
        break;
    ...
    case Stage::Output:
        if (oldStage == Stage::Middle || oldStage == Stage::Input)
            ...
            ImLayout::Spring(1, 0);
        ImLayout::BeginVertical("outputs", ImVec2(0, 0), 1.0f);
