...
struct HERON_API Activation {
  ...
  static void relu_inplace(const std::vector<float>& Z,
                           std::vector<float>& out);
  static void relu_deriv_inplace(const std::vector<float>& Z,
                                 std::vector<float>& out);
  static void tanh_inplace(const std::vector<float>& Z,
                           std::vector<float>& out);
  static void tanh_deriv_inplace(const std::vector<float>& Z,
                                 std::vector<float>& out);
  static void softmax_inplace(const std::vector<float>& Z,
                              std::vector<float>& out);
};
}  // namespace Heron
